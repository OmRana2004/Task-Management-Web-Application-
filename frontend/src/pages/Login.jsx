  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-[-10%] right-[-5%] w-96 h-96 rounded-full opacity-40"
          style={{ background: "radial-gradient(circle, #c7d2fe, transparent)" }} />
        <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 rounded-full opacity-30"
      ...
      <FloatingIcon style={{ top: "10%", left: "7%", width: 52, height: 52, background: "#eef2ff", border: "1px solid #c7d2fe", color: "#6366f1" }}>
        ✦
      </FloatingIcon>
      <FloatingIcon style={{ top: "18%", right: "7%", width: 46, height: 46, background: "#ecfdf5", border: "1px solid #a7f3d0", color: "#10b981", animationDelay: "0.6s" }}>
        ✓
      </FloatingIcon>
      <FloatingIcon style={{ top: "50%", left: "4%", width: 40, height: 40, background: "#fffbeb", border: "1px solid #fde68a", color: "#f59e0b", animationDelay: "1.1s" }}>
        ⚡
      </FloatingIcon>
      <FloatingIcon style={{ bottom: "18%", left: "7%", width: 48, height: 48, background: "#f0f9ff", border: "1px solid #bae6fd", color: "#0ea5e9", animationDelay: "1.6s" }}>
        🎯
      </FloatingIcon>
      <FloatingIcon style={{ bottom: "10%", right: "7%", width: 44, height: 44, background: "#fdf4ff", border: "1px solid #e9d5ff", color: "#a855f7", animationDelay: "0.9s" }}>
        ◈
      </FloatingIcon>
      <FloatingIcon style={{ top: "68%", right: "5%", width: 40, height: 40, background: "#fff1f2", border: "1px solid #fecdd3", color: "#f43f5e", animationDelay: "1.3s" }}>
        🔥
      </FloatingIcon>
      <FloatingIcon style={{ top: "35%", left: "9%", width: 36, height: 36, background: "#ecfdf5", border: "1px solid #a7f3d0", color: "#10b981", animationDelay: "2s" }}>
        📋
      </FloatingIcon>
      <FloatingIcon style={{ bottom: "38%", right: "9%", width: 36, height: 36, background: "#eef2ff", border: "1px solid #c7d2fe", color: "#6366f1", animationDelay: "0.4s" }}>
        ⭐
      </FloatingIcon>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mt-4 flex-wrap">
          {["Free forever", "No credit card", "Instant access"].map((text) => (
            <span
              key={text}
              className="flex items-center gap-1 text-[11px] font-medium text-slate-500 px-2.5 py-1 rounded-full bg-white"
